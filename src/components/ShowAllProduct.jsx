                ...
                <div className="col-lg-4 col-md-6" key={product._id}>
                  <div className=" bg-white shadow-lg rounded-lg overflow-hidden">
                    <div className="product-image p-2">
                      <img className="w-full object-cover rounded-lg" src={(product.imagePath) ? `https://mern-stack-frist-project.onrender.com/ProductImgUpload/${product.imagePath}` : (ProductImage)} alt={product.name} />
                    </div>
                    <div className="p-4">
